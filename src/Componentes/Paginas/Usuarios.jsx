    ...
    const estilos = {
        ...
        modalDeleteHeader: temaOscuro 
        ? { backgroundColor: "#7f1d1d", color: "#fecaca" } 
        : { backgroundColor: "#b02a2a", color: "white" },
        modalDeleteBody: temaOscuro 
    ...
    return (
        ...
        {showDeleteModal && (
            ...
            <div className="modal-dialog" style={{ marginTop: '100px' }}>
                <div className="modal-content" style={estilos.modalDeleteBody}>
                <div className="modal-header" style={estilos.modalDeleteHeader}>
                    <h5 className="modal-title">Confirmar Eliminación</h5>
                    <button 
                    type="button" 
                    className="btn-close"
                    style={temaOscuro ? { filter: "invert(1)" } : {}}
